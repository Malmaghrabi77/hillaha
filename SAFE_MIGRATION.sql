-- ============================================================
-- HILLAHA SAFE MIGRATION
-- النسخة الآمنة جداً - بدون مشاكل references
-- التاريخ: 2026-02-28
-- ============================================================
...
-- ============================================================
-- STEP 2: Add missing columns to partners
-- ============================================================

DO $$ BEGIN
  -- Add each column with IF NOT EXISTS check
...
-- ============================================================
-- STEP 5: Create store_admins table (WITHOUT user_id reference)
-- ============================================================
...
SELECT '✅ SAFE MIGRATION COMPLETE - ALL TABLES CREATED' as status;
